...
<div className="grid sm:grid-cols-1 md:grid-cols-2 gap-5">
  ...
  <Divider divideColor="bg-primary"/>
    ...
    <p className="text-lg font-thin leading-normal ml-4 py-4">With deep expertise in navigating the complexities of talent acquisition, 
...
<h2 className="text-primary text-2xl font-medium m-6 ml-4">Skilled Personnel</h2>
<p className="text-lg font-thin leading-normal ml-4">
We source and supply top-tier professionals from across Africa, Western nations, and Eastern regions, 
ensuring that you have access to a broad spectrum of expertise.
</p>


<h2 className="text-primary text-2xl font-medium m-6 ml-4">Extensive Database</h2>
<p className="text-lg font-thin leading-normal ml-4">
Our expansive resume database is rich with experienced, talented, and skilled individuals who are ready to meet the specific needs of your industry.
</p>


<h2 className="text-primary text-2xl font-medium m-6 ml-4">Foreign Worker and Expatriate Document Management</h2>
<p className="text-lg font-thin leading-normal ml-4">
We expertly manage all aspects of documentation for foreign workers and expatriates, including work permits,
residence permits, and other essential legal requirements.
</p>


<h2 className="text-primary text-2xl font-medium m-6 ml-4">Airport Assistance</h2>
<p className="text-lg font-thin leading-normal ml-4">
Our meet-and-greet services provide seamless support for arrivals, departures, and transit passengers, 
ensuring a smooth transition for your workforce
</p>


<h2 className="text-primary text-2xl font-medium m-6 ml-4">Visa Support</h2>
<p className="text-lg font-thin leading-normal ml-4">
We handle a wide range of visa requirements, including multiple-entry, single-entry, visa-on-arrival,
 and visa extensions, making the process hassle-free for both employers and employees.
</p>

<h2 className="text-primary text-2xl font-medium m-6 ml-4">Manpower Categories</h2>
<p className="text-lg font-thin leading-normal ml-4">
...
<section>
      <div className="relative bg-manpower w-full h-[500px] bg-cover bg-center">
