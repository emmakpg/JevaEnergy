import { Header } from "@/components/Header"
 ...
 const ContactUsPage = () => {
  return (
    ...
    <div>
    <section class="py-10 bg-gray-100 sm:py-16 lg:py-10">
                    ...
                    <form action="#" method="POST" class="mt-14">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <button type="submit" class="inline-flex items-center justify-center w-full px-4 py-4 mt-2 text-lg font-medium text-white transition-all duration-200 bg-sky-900 hover:bg-sky-800 border border-transparent rounded-md focus:outline-none  focus:bg-sky-800 ">
                                    Send
                                </button>
                            </div>
                        </div>
