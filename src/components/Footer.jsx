...
export const Footer = () => {
  return (
    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                        ...
                        {navLinks.map((item,index)=>(
                            <li key={index} >
                                <Link href={item.href} className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600">
                                {item.label}
                                </Link>
                            </li>
                        ))}
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                ...
                <form action="#" method="POST" class="mt-6">
                    ...
                    <button type="submit" className="inline-flex items-center justify-center px-6 py-4 mt-3 font-medium text-lg text-white transition-all duration-200 bg-sky-900 hover:bg-sky-800  focus:bg-sky-700 rounded-lg">
                    <FaAngleRight className=" -ml-3 mr-1" />
                    Subscribe</button>
                </form>
            </div>
        </div>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by Jeva</p>
    </div>
</section>
